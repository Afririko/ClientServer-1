...
Public rs_supplier As ADODB.Recordset
Public rs_save As New ADODB.Recordset
...
Set db = New ADODB.Connection
  ...
  db.Open "Provider=Microsoft.Jet.OLEDB.4.0;Data Source= db.mdb ;Persist Security Info=False;Jet OLEDB:"
